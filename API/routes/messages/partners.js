...
module.exports = [
    {
        ...
        handler: async (request, h) => {
            try {
                ...
                SELECT username as partner, firstName, lastName, status, avatar
                ...
                GROUP BY username
                ORDER BY max(createdAt) DESC`, { replacements: [username,username], type: db.sequelize.QueryTypes.SELECT});
                if (!results) {
